package com.mg.aroma.fetcher.model;
...
public class PinModel implements Parcelable {
    ...
    public static final Parcelable.Creator<PinModel> CREATOR
            = new Parcelable.Creator<PinModel>() {
    ...
    public  static  class User implements Parcelable{
        ...
        public static  class ProfileImages implements Parcelable{
            ...
            public static final Parcelable.Creator<ProfileImages> CREATOR
                    = new Parcelable.Creator<ProfileImages>() {
